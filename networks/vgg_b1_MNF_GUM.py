...
import tensorflow_probability as tfp
from Prueba.tf_mnf.Gumbel.mnf_conv import mnf_conv
from Prueba.tf_mnf.Gumbel.mnf_dense import mnf_dense
...
class VGG(tf.keras.Model):
    def __init__(self, vgg_name, num_classes):
        ...
        self.fc = mnf_dense(num_classes, prior_choice='standard_gumbel')
    ...
    def _make_layers(self, config):
        ...
        for l in config:
            if l == 'M':
                ...
                layer += [mnf_conv(l, 3, prior_choice='standard_gumbel'), 
